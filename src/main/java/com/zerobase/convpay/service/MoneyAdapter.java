...
public class MoneyAdapter implements PaymentInterface{
    ...
    public MoneyUseCancelResult payCancel(Integer payCancelAmount) {
        System.out.println("MoneyAdapter.payCancel : " + payCancelAmount);
    ...
    public MoneyUseCancelResult useCancel(Integer payCanceledAmount) {
        System.out.println("MoneyAdapter.useCancel : " + payCanceledAmount);

        if(payCanceledAmount < 100) {
            return MoneyUseCancelResult.MONEY_USE_CANCEL_FAIL;
        }
